function Worker(){
  ...
  Worker.__sendStats = sendStats;
  Worker.__moduleName = $intern_4;
  Worker.__errFn = null;
  Worker.__moduleBase = $intern_6;
  Worker.__softPermutationId = $intern_7;
  Worker.__computePropValue = null;
  Worker.__getPropMap = null;
  Worker.__installRunAsyncCode = function(){
  }
  ;
  Worker.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  Worker.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  Worker.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  Worker.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[Worker.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (Worker.__errFn) {
        script.onerror = function(){
          Worker.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  Worker.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  Worker.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    Worker.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return Worker.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    Worker.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = Worker.__getPropMap;
    ...
    Worker.__softPermutationId = softPermutationId;
  ...
  processMetas();
  Worker.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = Worker.__moduleBase;
